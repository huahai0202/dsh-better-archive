...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zhDict = {
      ...
      confirmDeleteBody: '冷会话会立即永久删除；当前仍存活的会话会先移入「已删除」区域显示，并在下次 DSH 启动时永久删除，重启前点「恢复」可撤销。',
      restartDelete: '重启后删除',
      deletedLabel: '已删除',
      deletedSection: '已删除',
      restore: '恢复',
      scheduledNotice: '{count} 个仍在使用中的会话已移入「已删除」区域，将在重启 DSH 后永久删除。',
    ...
    var enDict = {
      ...
      confirmDeleteBody: 'Cold sessions are deleted immediately. Sessions still in use are moved to the Deleted section now and permanently deleted the next time DSH starts; Restore before restarting cancels that.',
      restartDelete: 'Delete after restart',
      deletedLabel: 'Deleted',
      deletedSection: 'Deleted',
      restore: 'Restore',
      scheduledNotice: '{count} session(s) still in use were moved to the Deleted section and will be permanently deleted after DSH restarts.',
