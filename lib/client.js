  ...
  factory: (require) => {
    ...
    if (typeof document !== 'undefined' && !document.getElementById(STYLE_ID)) {
      ...
      styleEl.textContent = [
        ...
        '._dsh_ba_select > ._dsh_ba_trigger { flex: 1 1 auto; min-width: 0; justify-content: space-between; gap: 8px; }',
    ...
    function SelectMenu(props) {
      ...
      for (var i = 0; i < props.options.length; i++) {
        if (String(props.options[i].value) === String(props.value)) { current = props.options[i]; break }
      }

      var items = props.label ? [{ type: 'label', id: '__label', text: props.label }] : []
      props.options.forEach(function (option) {
        items.push({ id: String(option.value), label: option.label })
      })
    ...
    function ArchivedSection(props) {
      ...
      var acknowledgedState = React.useState(false)
      var acknowledged = acknowledgedState[0]
      var setAcknowledged = acknowledgedState[1]
      ...
      return createElement(
        ...
        notice ? createElement('p', { style: { fontSize: 13, lineHeight: '20px', color: 'var(--dsw-alias-state-success-primary, #18794e)', margin: 0 } }, notice) : null,
        ...
        allRows.length === 0
          ...
          : groups.length === 0
            ...
            : createElement('div', {
                ...
                style: { display: 'flex', flexDirection: 'column', gap: 14, maxHeight: '60vh', overflowY: 'auto', paddingRight: 4 },
              },
