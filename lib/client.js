  ...
  factory: (require) => {
    ...
    function ArchivedSection(props) {
      ...
      return createElement(
          ...
          ? // The pane's 38px header row, like the file tree's: the tab chip
            ...
            createElement('div', {
              style: {
                ...
                boxSizing: 'border-box', height: 38, padding: '0 2px 0 8px',
              ...
              createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 8, flex: '1 1 auto', minWidth: 0 } },
                createElement(Icon, { name: 'IconArchiveOutline20', size: 18 }),
                createElement('span', {
                  style: {
                    minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
        ...
        isSidebar
          ? // Controls stack for the narrow column: search takes a full row, the
            // two selectors share the row under it.
            createElement('div', { style: { display: 'flex', flex: '0 0 auto', flexDirection: 'column', gap: 6, minWidth: 0 } },
              createElement('div', { className: '_dsh_ba_search', style: { display: 'block', width: '100%' } },
            ...
            : createElement('div', {
                ...
                style: isSidebar
                  ? {
                      ...
                      // leftover height and scrolls itself, bar 2px clear of
                      // the edge like the workspace list.
                      flex: '1 1 auto', minHeight: 0, minWidth: 0,
                      marginRight: 2, padding: '8px 0 8px 8px',
