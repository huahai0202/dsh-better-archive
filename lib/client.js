...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zhDict = {
      ...
      confirmDeleteBody: '此操作将永久删除所选的已归档聊天，且无法恢复。',
      cancel: '取消',
    }
    ...
    var enDict = {
      ...
      confirmDeleteBody: 'This permanently deletes the selected archived chats and cannot be undone.',
      cancel: 'Cancel',
    }
                        ...
                        return createElement(
                          ...
                          (function () {
                            ...
                            return createElement('div', { style: { flex: '1 1 auto', minWidth: 0 } },
                               createElement('div', { style: { fontSize: 14, fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, row.title),
